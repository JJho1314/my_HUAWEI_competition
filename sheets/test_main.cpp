...
struct CarState
{
    ...
    float angular_speed;
    CarState(){};
    CarState(float x_, float y_, float yaw_, float speed_, float angular_speed_) : x(x_), y(y_), yaw(yaw_), speed(speed_), angular_speed(angular_speed_)
    {
    }
};
//---------------------------------struct---------------------------------
...
int main()
{
    ...
    while (scanf("%d", &frameID) != EOF)
    {
        ...
        robot[1].point_tracking(3.25, 48.75);
