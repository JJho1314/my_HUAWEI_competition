        ...
        if (frameID > 5 && K==43)
        {
            ...
            for (int j = 0; j < max_wb_num; j++)
            {
                for (int i = 0; i < WB8[0].need_material_map[7].size(); i++)
                {
                    int wb_index;
                    // 找到所有4工作台中还未生产但有缺的
                    if ((work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 0 || work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 32 || work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 64 || work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 96))
                    {
                        if (j < WB7[WB8[0].need_material_map[7][i]].need_material_map[4].size())
                        {
                            wb_index = WB7[WB8[0].need_material_map[7][i]].need_material_map[4][j];
                    ...
                    // 找到所有6工作台中还未生产但有缺的
                    if ((work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 0 || work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 32 || work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 16 || work_bench_v7[WB8[0].need_material_map[7][i]].raw_material == 48))
                    {
                        if (j < WB7[WB8[0].need_material_map[7][i]].need_material_map[6].size())
                        {
                            wb_index = WB7[WB8[0].need_material_map[7][i]].need_material_map[6][j];
            ...
            for (int j = 0; j < max_wb_num; j++)
            {
                if(j < WB8.size())
                {
                    for (int i = 0; i < WB8[j].need_material_map[7].size(); i++)
                    {
                        int wb_index;
                        // 找到所有4工作台中还未生产但不缺的
                        if (j < WB7[WB8[j].need_material_map[7][i]].need_material_map[4].size())
                        {
                            wb_index = WB7[WB8[j].need_material_map[7][i]].need_material_map[4][j];
                            if ((work_bench_v4[wb_index].raw_material == 0))
                            {
                                target_sell_index.push_back(work_bench_v4[wb_index].arr_idx);
                                target_buy_index.push_back(work_bench_v1[WB4[wb_index].need_material_map[1][0]].arr_idx);
                        ...
                        // 找到所有5工作台中还未生产但不缺的
                        if (j < WB7[WB8[j].need_material_map[7][i]].need_material_map[5].size())
                        {
                            wb_index = WB7[WB8[j].need_material_map[7][i]].need_material_map[5][j];
                            if ((work_bench_v5[wb_index].raw_material == 0))
                            {
                                target_sell_index.push_back(work_bench_v5[wb_index].arr_idx);
                                target_buy_index.push_back(work_bench_v1[WB5[wb_index].need_material_map[1][0]].arr_idx);
                        ...
                        // 找到所有6工作台中还未生产但不缺的
                        if (j < WB7[WB8[j].need_material_map[7][i]].need_material_map[6].size())
                        {
                            wb_index = WB7[WB8[j].need_material_map[7][i]].need_material_map[6][j];
                            if ((work_bench_v6[wb_index].raw_material == 0))
                            {
                                target_sell_index.push_back(work_bench_v6[wb_index].arr_idx);
                                target_buy_index.push_back(work_bench_v2[WB6[wb_index].need_material_map[2][0]].arr_idx);
